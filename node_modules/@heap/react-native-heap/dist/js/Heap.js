...
import { autotrackPress, withHeapTouchableAutocapture, } from './autotrack/touchables';
...
export default {
    ...
    autocaptureTextInput: bailOnError(autocaptureTextInputChange(autocaptureTrack)),
